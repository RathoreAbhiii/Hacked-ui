                    ...
                    <div className="flex flex-row justify-end w-full pt-4">
                      <div className="flex flex-col items-start justify-start w-[99%] gap-[31px] p-6">
                        <div className="flex flex-row justify-start w-[99%] mt-[204px] ml-4">
                          <div className="flex flex-col items-start justify-start w-full pt-[380px] gap-px"
                            style={{
                              width: '1300px',
                              height: '550px',
                              marginTop: '-200px',
                            ...
                            <Heading size="xl" as="h1" className="!text-white-A700 tracking-[-1.58px]">
                              Scan legal documents with ease
                            </Heading>
                            <div className="flex flex-row justify-start w-full">
                              <div className="flex flex-row justify-start w-full">
                                <Text as="p" className="!text-white-A700">
                                  Our AI-powered scanner makes it easy to scan and extract data from contracts,
                                  agreements, and other legal documents. Get started today.
                                </Text>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="flex justify-center items-center w-full p-2 bg-gray-50 rounded-[12px]">
                          <Button className="tracking-[0.24px] min-w-[155px] border-2 border-black">Start scanning</Button>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-row justify-end w-full">
                  <div className="flex flex-col items-center justify-center w-full gap-10 p-4">
                    <div className="flex flex-row justify-start w-full mt-6">
                      <div className="flex flex-col items-start justify-start w-[78%] pt-[5px] gap-2.5"
                        style={{ marginLeft: '60px' }}
                      >
                        <Heading size="lg" as="h2" className="tracking-[-1.19px]">
                          Why scan with LegalLise?
                        </Heading>
                        <div className="flex flex-row justify-start w-full pb-0.5">
                          <div className="flex flex-row justify-start w-full">
                            <Text as="p" className="!text-gray-900">
                              LegalLise is an AI-powered scanner that makes it easy to scan and extract data from
                              contracts, agreements, and other legal documents. Our scanner is fast, accurate, and
                              secure, so you can trust the results.
                            </Text>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-row justify-center w-full mb-6 gap-12">
                      ...
                      <Link to="/chatbot">
                        ...
                        <div className="flex flex-col items-center justify-start w-full pb-3">
                          <div className="flex flex-row justify-center w-full">
                          <Link to="/chatbot">
                            <Text as="p" className="mt-0.5 !text-gray-900 !font-medium">
                          ...
                          <div className="flex flex-row justify-center w-full">
                            ...
                            >
                              Our AI-powered scanner makes it quick and easy to extract data from contracts, agreements,
            ...
            <div className="flex flex-row justify-center w-full">
              <div className="flex flex-row justify-center w-full max-w-[960px]">
                <div className="flex flex-col items-center justify-center w-full gap-6 p-5">
                  ...
                  <Img src="images/img_depth_5_frame_1.svg" alt="image_one" className="h-6" />
                  <div className="flex flex-row justify-center w-full mb-5">
                    <div className="flex flex-row justify-end w-full">
                      <Text as="p" className="mr-[315px] text-center">
                        © 2024 LegalLise. All rights reserved.
                      </Text>
                    </div>
                  </div>
                </div>
